...
<strong><a href="https://github.com/davidlpc1/davidlpc1_blog/archive/main.zip">Download ZIP</a></strong>
<strong>OR</strong>

```
git clone git@github.com:davidlpc1/davidlpc1_blog.git
```
